...
private slots:
    ...
    QString BuyPSBR(QString OrderType, double Quantity, double Rate);
    QString SellPSBR(QString OrderType, double Quantity, double Rate);
