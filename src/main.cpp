...
const string strMessageMagic = "Psbrcoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if (nHeight == 1){
        ...
        nSubsidy = 10 * COIN;
    } else if (nHeight < 15002) {
        nSubsidy = 300 * COIN;
    } else if (nHeight < 20003) {
        nSubsidy = 70 * COIN;
    } else if (nHeight < 25004) {
        nSubsidy = 100 * COIN;
    } else if (nHeight < 30005) {
        nSubsidy = 1000 * COIN;
    } else if (nHeight < 60,006) {
        nSubsidy = 25 * COIN;
    } else if (nHeight < 100,007) {
        nSubsidy = 125 * COIN;
    } else if (nHeight < 500,001) {
        nSubsidy = 75 * COIN;
    } else {
        // do nothing
    }
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if (nBestHeight < 5001) { 
        ...
        nSubsidy = 300 * COIN;
    } else if(nBestHeight < 15002) { 
        nSubsidy = 80 * COIN;
    } else if(nBestHeight < 20003) { 
        nSubsidy = 250 * COIN;
    } else if(nBestHeight < 25004) { 
        nSubsidy = 70 * COIN;
    } else if(nBestHeight < 30005) { 
        nSubsidy = 2000 * COIN;
    } else if(nBestHeight < 35006) { 
        nSubsidy = 60 * COIN;
    } else if(nBestHeight < 40007) { 
        nSubsidy = 150 * COIN;
    } else if(nBestHeight < 45008) { 
        nSubsidy = 50 * COIN;
    } else if(nBestHeight < 50009) { 
        nSubsidy = 1000 * COIN;
    } else if(nBestHeight < 55010) { 
        nSubsidy = 40 * COIN;
    } else if(nBestHeight < 60011) { 
        nSubsidy = 5000 * COIN;
    } else if(nBestHeight < 65012) { 
        nSubsidy = 40 * COIN;
    } else if(nBestHeight < 70013) { 
        nSubsidy = 50 * COIN;
    } else if(nBestHeight < 75014) { 
        nSubsidy = 100 * COIN;
    } else if(nBestHeight < 80015) { 
        nSubsidy = 60 * COIN;
    } else if(nBestHeight < 85016) { 
        nSubsidy = 1500 * COIN;
    } else if(nBestHeight < 90017) { 
        nSubsidy = 70 * COIN;
    } else if(nBestHeight < 95018) { 
        nSubsidy = 2000 * COIN;
    } else if(nBestHeight < 100019) { 
        nSubsidy = 700 * COIN;
    } else if(nBestHeight < 250020) { 
        nSubsidy = 1000 * COIN;
    } else if(nBestHeight < 500021) { 
        nSubsidy = 750 * COIN;
    } else if(nBestHeight < 750022) { 
        nSubsidy = 500 * COIN;
    } else if(nBestHeight < 1000023) { 
        nSubsidy = 250 * COIN;
    } else { 
...
{
    int64_t ret = blockValue * 0.85; //85% reward masternode
